...
$qry = mysqli_query($link,"select * from houses where id='$id'");
...
if(isset($_POST['update']))
{
    ...
    $edit = mysqli_query($link,"update houses set name='$name', place='$place', price='$price' where id='$id'");
        ...
        <div class="col-md-8 offset-md-2">
            <form method="POST">
                ...
                <div class="form-row form-group">
                    ...
                    <div class="col-sm-6 input-column"><input type="text" name="name" value="<?php echo $data['name'] ?>" placeholder="Enter name of the house" Required></div>
                </div>
                <div class="form-row form-group">
                    <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Place </label></div>
                    <div class="col-sm-6 input-column"><input type="text" name="place" value="<?php echo $data['place'] ?>" placeholder="Enter name of the place" Required></div>
                </div>
                <div class="form-row form-group">
                    <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Price </label></div>
                    <div class="col-sm-6 input-column"><input type="text" name="price" value="<?php echo $data['price'] ?>" placeholder="Enter the price" Required></div>
                </div><input class="btn btn-light submit-button" type="submit" name="update" value="Submit">
            </form>
        </div>
